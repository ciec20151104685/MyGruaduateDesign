...
<div class="loginform">
    <div class="col-md-4 column">
        ...
        <button id="loginbutton" class="btn btn-primary" onclick="login()">登录</button>
        <button id="registerbutton" class="btn btn-primary" onclick="register()">注册</button>
...
//        url   参数  回掉
        $.post("${pageContext.request.contextPath}/user/login", {username: username, password: password}, function (result) {
            if (result == "ok"){
...
//                alert("err");
    ...
    function register() {
        window.location.href = "${pageContext.request.contextPath}/user/register1"
